...
public class Deposite {
	...
	public void storeWeapons(int account){
		int answer2;
		boolean state = true;
		...
		//display old balance
		test.getBalanceByAccount(account);
		...
		do {
			...
			if(answer1.compareToIgnoreCase("yes") == 0) {
				...
				depositeWeapsonJoint(answer2);
				state = false;
			} else if (answer1.compareToIgnoreCase("no") == 0) {
				depositeWeapson(account);
				state = false;
			} else {
	...
	//function for backpack_number
	public void depositeWeapsonJoint(int number) {
		System.out.println("Deposite how many rifles?");
		numberOfAsualtRifles = UserInput.getIntMenu(9999);
		System.out.println("Deposite how many shotgun?");
		numberoOfShotguns = UserInput.getIntMenu(9999);
		System.out.println("Deposite how many smg?");
		numberOfSubmachineGuns  = UserInput.getIntMenu(9999);
		System.out.println("Deposite how many pistols?");
		numberOfPistols = UserInput.getIntMenu(9999);
		System.out.println("Deposite how many launcher?");
		numberOfRockets = UserInput.getIntMenu(9999);
		System.out.println("Deposite how many sniper?");
	...
	//function for account_number
	public void depositeWeapson(int number) {
		System.out.println("Deposite how many rifles?");
		numberOfAsualtRifles = UserInput.getIntMenu(9999);
		System.out.println("Deposite how many shotgun?");
		numberoOfShotguns = UserInput.getIntMenu(9999);
